#!/bin/bash
# Exp 2: DeepSeek DFlash + frozen + sfa=true + markov ONLY (zero-init W2, NO adapter)
set -uo pipefail
...
LABEL="exp2_ds_sfa_true_markov_only"
...
echo "=== Exp2 [${LABEL}] started at $(date) ==="
echo "DeepSeek DFlash | frozen | sfa=true | markov=256(zero-init W2) | NO adapter | loss=$LOSS_FN | ep=$EPOCHS"
